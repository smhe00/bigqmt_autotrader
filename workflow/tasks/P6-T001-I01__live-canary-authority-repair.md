...
audit_base_commit: 1e5c42e9a6e19107fb01a888ea95499751a8726d
expected_report: workflow/reports/P6-T001-I01__implementation-report.md
expected_review: workflow/reviews/P6-T001-I01__architect-review.md
---
...
Agent 只能将本轮执行回复写入上述 report 文件。报告必须包含：
